...
* __Não foi possivel construir os containers em docker. A arquitetura ARM64v8 não possibilita estabilidade do Windows Support for Linux (WSL) para que o build possa ser realizado. Foi improvizada uma tentativa de solução alternativa com arquivos de extensão exe.__
